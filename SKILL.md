...
description: >
  ...
  Детерминированные Python-скрипты + spaced repetition + трекинг прогресса.
  Используется когда: пользователь хочет готовиться к экзаменам Росавиации,
...
5. Установить `requests` если не установлен: `pip3 install requests`
